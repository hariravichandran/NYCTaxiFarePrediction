...
# train_raw['euclidean_distance'] = math.sqrt((train_raw['pickup_latitude'] - train_raw['dropoff_latitude']) ** 2 + (train_raw['pickup_longitude'] - train_raw['dropoff_longitude']) ** 2)
...
# average_fare = train_raw['fare_amount'].mean()
...
labels = labels[['fare_amount', 'fare_amount', 'passenger_count', 'euclidean_distance', 'pickup_hour', 'pickup_minute',
